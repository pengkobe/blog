            ...
            for (var i = 0; i < labelLen; i++) {
                ...
                if (i % label_y == 0) {
                    ...
                    if (index.i <= 1) {
                        ...
                        switch (ddd) {
                            case 1:
                                medium_value = 0.5 * Math.pow(10, index.i - 1);
                                break;
                            case 2:
                                medium_value = 1 * Math.pow(10, index.i - 1);
                                break;
                            case 3:
                                medium_value = 1.5 * Math.pow(10, index.i - 1);
                                break;
                            case 4:
                                medium_value = 2 * Math.pow(10, index.i - 1);
                                break;
                            case 5:
                                medium_value = 2.5 * Math.pow(10, index.i - 1);
                                break;
                            case 6:
                                medium_value = 3 * Math.pow(10, index.i - 1);
                                break;
                            case 7:
                                medium_value = 3.5 * Math.pow(10, index.i - 1);
                                break;
                            case 8:
                                medium_value = 4 * Math.pow(10, index.i - 1);
                                break;
                            case 9:
                                medium_value = 4.5 * Math.pow(10, index.i - 1);
                                break;
                        }
                    }
                    if (i == 0) {
